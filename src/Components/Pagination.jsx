          ...
          <ul className="flex">
            {PageNumber.map((item, i) => (
              <li key={item}>
                <a
                  onClick={() => paginate(i)}
                  className={`${currentPage == i+1 ? "flex items-center justify-center px-3 h-8 leading-tight text-white bg-[#262626] border border-gray-300  dark:border-gray-700 dark:text-gray-400"
                  : "flex items-center justify-center px-3 h-8 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400"
