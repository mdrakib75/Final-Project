          ...
          ? <div className="">
              <div className="flex flex-wrap justify-between ">
            {
              ...
              <div key={item.id} className="md:w-[31%] w-[48%]">
               ...
               {showAll ? cateFilter.length > 5 && <div className="" onClick={(handleShow)}><h2 className="pt-15">Show All...</h2></div> : <div className="" onClick={(handleLess)}><h2 className="pt-15">Show Less...</h2> </div>}
